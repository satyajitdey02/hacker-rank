...
public class LatencyRecorderRefactoredAdvanced {
    ...
    //I can keep the latency record in a thread-safe collection to avoid race condition.
    //May be this is not a good idea to use this List implementation where add/updates are frequent.
    //This List implementation copy and write elements on every add/update which is very expensive and cost performance
    private static List<Integer> lt = new CopyOnWriteArrayList<>();
